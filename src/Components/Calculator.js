...
import { Container, Screen, Prevoius, Current, Button } from '../styles/MainStyle'
    ...
    return (
        <>
            <Container>
                ...
                <Button control operation onClick={allclearHandler}>
                    {/* <Button gridSpan={2} control onClick={allclearHandler}> */}
                    AC
                </Button>
                <Button onClick={deleteHandler} operation>DEL</Button>
                ...
                <Button data={0} zero_btn gridSpan={2} onClick={appendValueHandler}>
                    0
                </Button>
